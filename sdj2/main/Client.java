...
import sdj2.controller.InterfaceModel;
import sdj2.controller.InterfaceNameAndIP;
...
public class Client {
	...
	private Client(String remoteHostName, int remotePortServer, int remotePortDirectory) {
	...
	private void connectToServer() {
		String connectLocation = "//" + remoteHostName + ":" + remotePortDirectory + "/DirectoryServer";
		String in = null;
		try {
