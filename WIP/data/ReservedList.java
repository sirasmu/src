...
public class ReservedList implements Serializable, RemoteSubject<ReservedList>, Iterable<Reserved> {
	...
	public void addObserver(RemoteObserver<ReservedList> arg0) throws RemoteException {

		rsd.addObserver(arg0);
	}

	@Override
	public void deleteObserver(RemoteObserver<ReservedList> arg0) throws RemoteException {
